         ...
         <div class="myPage_content">
            <div class="Password_box" >
               ...
               <ul class="delete_content_box">
                 ...
                 <li class="delete_Btn">
               <button type="button" style="height:25px; width:75px; border:none; background-image: url(${root}/resources/images/images/ok.png); background-size: 100%; margin-right:2%;"  onclick="confirmPass()"></button>
