         ...
         <div class="myPage_box">
            <form id="valiex" novalidate="novalidate" action="${root}/info/modifyMember" method="post" enctype="multipart/form-data">
               <div class="result_title">
                  <!-- login title -->
                  <img src="${root}/resources/images/images/modify.png" height="30">
               </div>
                  ...
                  <li>
                     <div class="profile_content">
                        ...
                        <p>
                           ...
                           <b class="label">닉네임</b> 
                           <input type="text" class="profile_input error" value="${memberDto.nickName}" name="nickName" style="margin-right:30px;">
                        </p>
                        <p>
                           <img src="${root}/resources/images/images/pick.png" height="25">
                           <b class="label">레벨</b> 
                              <c:if test="${memberDto.memberLv == 0}">
                                 <input type="text" class="profile_input error" value="일반회원" name="level" style="margin-reight:30px;" readonly>
                              </c:if>
