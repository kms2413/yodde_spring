      ...
      <div class="content" style="margin-bottom:16%;">                           <!-- content -->
         <div class="myPage_content">
            <div class="Password_box" >
               ...
               <button type="reset" style="height:25px; width:75px; border:none; background-image: url(${root}/resources/images/images/close_btn.png); background-size: 100%; margin-left : 8px;" onclick="javascript:history.back()"></button>
            </li>
             </ul>
           </div>
         </div>
