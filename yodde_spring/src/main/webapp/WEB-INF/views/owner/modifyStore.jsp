			...
			<form onsubmit="return checkForm()" action="modifyStore?storeId=${storeDto.storeId}&email=${email}" method="post" enctype="multipart/form-data">
				<div class="modifyStore_box">
						<div class="result_title">
							<img src="${root}/resources/images/images/store_info.png" height="30">
						</div>
						<div style="text-align: center; background-color: #f4f4f4;">
							...
							<div class="file_input" style="padding-left: 95px;">오픈날짜
							...
							<div class="file_input" style="padding-right: 80px;">가게 상황
