			...
			<div class="followerList_content">
				<div class="followerList_box">
					<div class="result_title">					<!-- login title -->
						<img src="${root}/resources/images/images/storefollowing.png" height="30">
					</div>
								...
								<c:forEach var="storeList" begin="0" varStatus="status" end="${fn:length(storeFollowingList)}" items="${storeFollowingList}">
									<li class="myProfile">
										<div class="myPhoto" style="padding-top:20px">
											<a href="${root}/AjaxStore?storeId=${storeList.storeId}"><img src="${root}/resources/images/images/ex1.jpg" width="130px"></a>
										</div>
