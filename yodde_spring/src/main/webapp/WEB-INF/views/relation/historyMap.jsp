...
<body style="min-width: 1260px;">
	...
	<div class="content">
		...
		<div class="historyMap_content">
			<div class="historymap_box">
				...
				<div class="map_box" style="margin-top:18px;">
					<div id="scholes"
			...
			<div class="historyreview_box">
				<div class="HR_board" style="margin:0px 0px 0px 16%;">
				<!-- DB에서 받아서 리뷰 뿌려주는 부분 -->
					<c:forEach begin ="0" end = "${fn:length(reviewList)}" var="itemReview" varStatus="itemStatus" items="${reviewList}">
						...
						<c:forEach begin="0" end="${fn:length(nameList)}" var="storeName" items="${nameList}">
								<c:if test="${itemReview.storeId == storeName.storeId}">
									...
									<img src="${root}/resources/images/images/up.png" height="30"> ${itemReview.like1} 
									<img src="${root}/resources/images/images/down.png" height="30">${itemReview.unlike}
								</span>
									<p class="HRscroll_tag">${itemReview.content}</p> <span>
										<span class="HR_photo_position"> <!-- 리뷰에 첨부된 사진들 --> 
											<a href=""><img src="${root}/resources/images/images/pic1.png" height="40"></a>
											<a href=""><img src="${root}/resources/images/images/pic2.png" height="40"></a>
											<a href=""><img src="${root}/resources/images/images/pic3.png" height="40"></a>
									</span>
	...
	<!-- 지도부분 -->
	<script type="text/javascript"
		src="http://openapi.map.naver.com/openapi/naverMap.naver?ver=2.0&key=41bb395d4b47bc9014558eb8e82edd91&coord=latlng"></script>
