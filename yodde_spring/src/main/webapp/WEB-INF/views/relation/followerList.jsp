...
<html>
   ...
   <body style="min-width:1260px;">
      ...
      <div class="content"style="margin-bottom:12%;">                           <!-- content -->
         <div class="followerList_content">
            <div class="followerList_box">
               <div class="result_title">               <!-- login title -->
                  <img src="${root}/resources/images/images/follower.png" height="30">
               </div>
                        ...
                        <c:forEach var="memList" begin="0" varStatus="status" end="${fn:length(followerList)}" items="${followerList}">
                           <li class="myProfile">
                              <div class="myPhoto" style="padding-top:20px">
                                 <a href="${root}/member/memberMyPage?email${memList.follower}"><img src="${root}/resources/images/images/profile.png" width="130px"></a>
                              </div>
