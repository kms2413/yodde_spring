   ...
   <form action="${root}/requestRegStore" method="post">
      <div class="storeRegInfo_content">
         <div class="title" style="margin-left:3%;">
            <img src="${root}/resources/images/images/store_reg.png" height="30px;">
         </div>
         ...
         <ul>
            ...
            <li>
               ...
               <textarea cols="60" class="reg_address" id="context" name="address" style="resize:none; margin-bottom:2%;"></textarea>
            </li>      
