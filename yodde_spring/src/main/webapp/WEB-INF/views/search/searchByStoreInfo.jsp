...
<body style="min-width:1260px;">
	...
	<div class="content"> 						<!-- content -->
		<div class="HP_content" style="margin-left:25%;">
			<div class="HP_box">
				<c:choose>
									...
									<ul class="HP_store_reviewnum">
					                  <li class="store_icon">
					                     ...
					                     <c:if test="${storeInfo.reservation==1}">
					                        <img src="${root}/resources/images/images_store_info/reservation.png" width="30" height="35" style="margin-right: 10px;">
					                     </c:if>
					                     <c:if test="${storeInfo.delivery==1}">
					                        <img src="${root}/resources/images/images_store_info/delivery.png" width="30" height="35" style="margin-right: 10px;">
					                     </c:if>
					                     <c:if test="${storeInfo.takeOut==1}">
					                        <img src="${root}/resources/images/images_store_info/takeout.png" width="30" height="35" style="margin-right: 10px;">
					                     </c:if>
					                     <c:if test="${storeInfo.creditCard==1}">
					                        <img src="${root}/resources/images/images_store_info/card.png" width="30" height="35" style="margin-right: 10px;">
					                     </c:if>
					                     <c:if test="${storeInfo.parking==1}">
					                        <img src="${root}/resources/images/images_store_info/parking.png" width="30" height="35" style="margin-right: 10px;">
					                     </c:if>
					                     <c:if test="${storeInfo.group1==1}">
					                        <img src="${root}/resources/images/images_store_info/group.png" width="30" height="35" style="margin-right: 10px;">
					                     </c:if>
					                     <c:if test="${storeInfo.toilet==1}">
					                        <img src="${root}/resources/images/images_store_info/toilet.png" width="30" height="35" style="margin-right: 10px;">
					                     </c:if>
					                     <c:if test="${storeInfo.wifi==1}">
					                        <img src="${root}/resources/images/images_store_info/wifi.png" width="30" height="35" style="margin-right: 10px;">
					                     </c:if>
					                     <c:if test="${storeInfo.tv==1}">
					                        <img src="${root}/resources/images/images_store_info/tv.png" width="30" height="35" style="margin-right: 10px;">
					                     </c:if>
					                     <c:if test="${storeInfo.seating==1}">
					                        <img src="${root}/resources/images/images_store_info/seating.png" width="30" height="35" style="margin-right: 10px;">
					                     </c:if>
					                     <c:if test="${storeInfo.kids==1}">
					                        <img src="${root}/resources/images/images_store_info/kids.png" width="30" height="35" style="margin-right: 10px;">
					                     </c:if>
					                     <c:if test="${storeInfo.driveThrough==1}">
					                        <img src="${root}/resources/images/images_store_info/drive_through.png" width="30" height="35" style="margin-right: 10px;">
					                     </c:if>
					                  </li>
									</ul>
								</li>
