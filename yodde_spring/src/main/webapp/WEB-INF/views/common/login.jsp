				...
				<div class="login_box">
					<form onsubmit="return checkForm()" action="/home/j_spring_security_check" method="post">
						<div class="result_title">				<!-- login title -->
							<img src="${root}/resources/images/images/logintitle.png" height="30">
						</div>
						...
						<div class="bottom_Btn">
							...
							<a href="" onclick="">
							 ...
							 -->
							<input type="IMAGE" src="${root}/resources/images/images/LOGINbtn.png" height="30" name="Submit" value="Submit" style="margin-right:6px;">
							<a href="/home/member/join" onclick="">
								<img src="${root}/resources/images/images/JOIN.png" height="30"style="margin-right:6px;">
							</a>
