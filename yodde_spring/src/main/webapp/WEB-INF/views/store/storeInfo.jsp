         ...
         <div class="storeInfo_content">
            ...
            <div class="first_box">
               <ul class="storeInfo_ul">
                  <li class="storeInfo_box" style="margin-right:35%;">
...
<%--                      ${pictureList.size()==0} --%>
            ...
            <div class="write_box">
               ...
               <div class="review_board">
                  ...
                  <c:forEach var="itemReview" items="${reviewList}">
                        ...
                        <c:if test="${itemReview.writer_email!=email}">
                           <input type="hidden" value="2" id="historyCheck"/>
                        </c:if>
                     <div class="review">
                        <!-- DB에서 리뷰 받아와서 뿌려줌 -->
      ...
      <script type="text/javascript" src="http://openapi.map.naver.com/openapi/naverMap.naver?ver=2.0&key=41bb395d4b47bc9014558eb8e82edd91&coord=latlng"></script>
         <script type="text/javascript">
