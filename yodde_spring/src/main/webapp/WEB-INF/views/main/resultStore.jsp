                              ...
                              <ul style="none;" class="HP_thumbnails">
                                 ...
                                 <c:forEach items="${storeDto}" var="storeDto">
                                    <li class="HP_stores">
                                       ...
                                       <span class="HP_store_starrate">
                                          <span>
                                          <c:if test="${storeDto.rate<0.25}">
                                             <img src="${root}/resources/images/images/rate_zero.png">
                                          </c:if>
                                          <c:if test="${storeDto.rate>= 0.25 && storeDto.rate<0.75}">
                                             <img src="${root}/resources/images/images/rate_half.png">
                                          </c:if>
                                          <c:if test="${storeDto.rate >= 0.75 && storeDto.rate<1.25}">
                                             <img src="${root}/resources/images/images/rate_one.png">
                                          </c:if>
                                          <c:if test="${storeDto.rate >= 1.25 && storeDto.rate<1.75}">
                                             <img src="${root}/resources/images/images/rate_1half.png">
                                          </c:if>
                                          <c:if test="${storeDto.rate >= 1.75 && storeDto.rate<2.25}">
                                             <img src="${root}/resources/images/images/rate_two.png">
                                          </c:if>
                                         <c:if test="${storeDto.rate >= 2.25 && storeDto.rate<2.75}">
                                             <img src="${root}/resources/images/images/rate_2half.png">
                                          </c:if>
                                          <c:if test="${storeDto.rate >= 2.75 && storeDto.rate<3.25}">
                                             <img src="${root}/resources/images/images/rate_three.png">
                                          </c:if>
                                          <c:if test="${storeDto.rate >= 3.25 && storeDto.rate<3.75}">
                                             <img src="${root}/resources/images/images/rate_3half.png">
                                          </c:if>
                                          <c:if test="${storeDto.rate >= 3.75 && storeDto.rate<4.25}">
                                             <img src="${root}/resources/images/images/rate_four.png">
                                          </c:if>
                                          <c:if test="${storeDto.rate >= 4.25 && storeDto.rate<4.75}">
                                             <img src="${root}/resources/images/images/rate_4half.png">
                                          </c:if>
                                          <c:if test="${storeDto.rate >= 4.75 && storeDto.rate<=5}">
                                             <img src="${root}/resources/images/images/rate_five.png">
                                          </c:if>
                                          </span>${storeDto.rate}
                                       </span>
                                          	</span>
