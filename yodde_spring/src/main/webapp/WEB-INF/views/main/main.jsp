        ...
        function initialize(){
            ...
            GoogleMap = {initialize : function(latitude, logitude) {
                ...
                function(result, status) {
                   ...
                   var email="${email}";
                     var param="email=" + email + "&address=" + addr;
                          $.ajax({
                             url:"MainAjax?" + param,
                             type:"get",
                             dataType:"json",
                         ...
                         var locationStore=data.storeList;
                         ...
                         var locationTit = "#locationTit1";
                         var locationAdd = "#locationAdd1";
                         var locationPic = "#locationPic1";
                         var locationHrf = "#locationHrf1";
                         ...
                         for(i; i <=6;){
                                  ...
                                  // 지역중심 ajax 적용
                                  $(locationTit).text(locationStore[i-1].category1);
                                  $(locationAdd).text(locationStore[i-1].storeName);
                                  if(locationStore[i-1].profilePic != ''){
                                     $(locationPic).css("background", "url(\""+ "${root}" + locationStore[i-1].profilePic +"\")");   
                                  }else{
                                     $(locationPic).css("background", "url('/home/resources/images/images/ex4.jpg')");
                                  }
                                  $(locationPic).css("background-size", "100% 100%");
                                  var item="&storeId="+locationStore[i-1].storeId;
                                  $(locationHrf).attr("href","/home/AjaxStore?"+ item);
                                  ...
                                  locationTit = "#locationTit";
                             locationAdd = "#locationAdd";
                              locationPic = "#locationPic";
                             locationHrf = "#locationHrf";
      ...
      <div class="content">
         <div class="main_content">
               ...
               <div class="stores" id="pic_slide">
                  <div class="slide_title">
                     <ul id="carousel2" class="elastislide-list">
                        <c:forEach begin="1" end="6" varStatus="s">
                           <li class="main_recommend" id="location">
                              <a href="#" id="locationHrf${s.count}">
                                 <div id="locationPic${s.count}" class="pic1" style="background: url(/home/resources/images/images/ex1.jpg); background-size: 250px;">
                                    <div class="text">
                                       <span id="locationTit${s.count}" class="tit">7Train</span><br/>
                                       <span id="locationAdd${s.count}" class="add">강남역 11번 출구</span>
                                    </div>
                                 </div>
                              </a>
                           </li>
            ...
            <c:if test="${status == 'member'}">
               <div class="store_box">
                  <div class="store_box_title">
                     <img src="${root}/resources/images/images/5_follwing member.png" height="30">
                  </div>
                  <div class="stores" id="pic_slide">
                     <div class="slide_title">
               ...
               <div class="store_box">
                  <div class="store_box_title">
                     <img src="${root}/resources/images/images/6_follwing store.png" height="30">
                  </div>
                  <div class="stores" id="pic_slide">
                     <div class="slide_title">
